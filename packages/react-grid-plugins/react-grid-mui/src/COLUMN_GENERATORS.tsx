import type { ColDefMui, PluginConfigMui } from "#types.ts";
...
export type ColumnGeneratorMui<D extends ColumnDataType> = ColumnGenerator<
  PluginConfigMui,
  D
>;
...
const stringColumnGenerator: ColumnGeneratorMui<"string"> = (params) => {
...
const booleanColumnGenerator: ColumnGeneratorMui<"boolean"> = (params) => {
  return extendBaseColumn(params, {
    type: "boolean",
    sortable: true,
    filterable: true,
...
const numberColumnGenerator: ColumnGeneratorMui<"number"> = (params) => {
  return extendBaseColumn(params, {
    type: "number",
    sortable: true,
    filterable: true,
...
const stringDateColumnGenerator: ColumnGeneratorMui<"stringDate"> = (
  params,
) => {
  return extendBaseColumn(params, {
    type: "dateTime",
...
const ujsonObjectColumnGenerator: ColumnGeneratorMui<"ujsonObject"> = (
  params,
) => {
  return extendBaseColumn(params, {
    // type: "actions",
...
const ujsonObjectArrayColumnGenerator: ColumnGeneratorMui<
  "ujsonObjectArray"
> = (params) => {
  return extendBaseColumn(params, {
    sortable: false,
...
const ujsonValueColumnGenerator: ColumnGeneratorMui<"ujsonValue"> = (
  params,
) => {
  return extendBaseColumn(params, {
    sortable: false,
